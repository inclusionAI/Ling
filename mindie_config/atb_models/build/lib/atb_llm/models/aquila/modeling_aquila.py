...
class FlashAquilaAttention(FlashAttention):
    def __init__(self, prefix: str, config, weights, **kwargs):
        super().__init__(prefix, config, weights, **kwargs)
        self.load_weights(**kwargs)


class FlashAquilaLayer(FlashLayer):
    ...
    def load_weights(self, **kwargs):
        ...
        self.mlp = AquilaMLP(prefix=f"{self.prefix}.mlp", config=self.config, weights=self.weights, **kwargs)
