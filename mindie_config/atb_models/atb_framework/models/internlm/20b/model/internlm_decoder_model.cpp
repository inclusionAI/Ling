...
InternlmDecoderModel::InternlmDecoderModel(const std::string &param) : atb_speed::base::DecoderModel(param)
{
}

atb::Status InternlmDecoderModel::CreateLayerOperation(atb::Operation **op, uint32_t layerId)
{
    atb_speed::base::LayerParam layerParam;
    atb_speed::base::DecoderModel::SetLayerParam(layerParam, layerId);
    InternlmDecoderLayer decoderLayer(layerParam);
