...
PERF_FILE = "./examples/models/minicpm_llama3_v2/minicpm_llama3_v2_performance.csv"
...
PRED_FILE = "./examples/models/minicpm_llama3_v2/predict_result.json"


class MinicpmLlama3V2Runner(MultimodalPARunner):
...
def parse_arguments():
    ...
    parser_minicpmllama.add_argument('--image_or_video_path',
                        help="image_or_video path",
                        default="/data/acltransformer_testdata/minicpm_llama3_v2",
                        validator=path_validator,
                        )
    parser_minicpmllama.add_argument(
    ...
    return parser_minicpmllama.parse_args()
...
if __name__ == '__main__':
    ...
    pa_runner = MinicpmLlama3V2Runner(**input_dict)
