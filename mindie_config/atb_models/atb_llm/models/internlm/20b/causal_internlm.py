...
class InternlmForCausalLM(CausalLM):
    ...
    def init_ascend_operations(self, config: InternlmConfig):
        # 初始化模型
        self.acl_encoder_operation = torch.classes.ModelTorch.ModelTorch("Internlm_parallel_20b_InternlmDecoderModel")
        self.acl_decoder_operation = torch.classes.ModelTorch.ModelTorch("Internlm_parallel_20b_InternlmDecoderModel")
